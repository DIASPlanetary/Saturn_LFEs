...
def main():
    ...
    data_start=pd.Timestamp('2004-01-07') #Badman figure 3 example
    data_end=pd.Timestamp('2004-01-08')
    ...
    plot = {
        ...
        "spectrogram_joint_polygons": False # Same as "two_spectograms" but now using JOINT .json file ----- EX. /Sample_Visualizations/Sample_Joined_Polygon.png
    }
